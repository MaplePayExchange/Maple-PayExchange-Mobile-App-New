			...
			<View className="flex-1 bg-white">
				<ScreenWrapper>
                    ...
                    */}
                    ...
                    |--------------------------------------------------
                    */}
					<View className="rounded-3xl bg-[#F9F9F9] p-5">
						{selectedWallet?.currency === 'CAD' && (
							<View className="mb-4 h-[20px] w-[60%] flex-row items-center justify-start gap-2 rounded-3xl border border-[#FEDF89] bg-[#FFFAEB] pl-2 pr-6">
                        ...
                        */}
						<View className={clsx(selectedWallet?.currency === 'CAD' ? 'flex' : 'hidden')}>
							<View className="z-50 flex-row items-center gap-2">
                            ...
                            */}
                            ...
                            |--------------------------------------------------
                            */}
							<View className="mt-6 h-[74px] flex-row items-center rounded-3xl bg-white p-4">
								<View>
									<MPText
										weight="regular"
										style={{ fontSize: 12 }}
							...
							|--------------------------------------------------
							*/}
							<MPButton useGradientBg className="mt-6 w-[194px] self-center">
								<Pressable
									onPress={() => {
