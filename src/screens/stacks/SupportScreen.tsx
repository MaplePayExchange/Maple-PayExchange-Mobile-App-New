...
import { Dimensions, Image, Linking, Pressable, ScrollView, TextInput, View } from 'react-native';
				...
				<ScrollView showsVerticalScrollIndicator={false}>
					...
					*/}
					<View className={clsx('flex-1 bg-white pb-16')} style={{ width: Dimensions.get('screen').width }}>
						...
						>
							<View className="flex-row h-full px-5 justify-between items-end pb-[32px] flex-1">
								{/**
								|--------------------------------------------------
								| Hello message
								|--------------------------------------------------
								*/}
								...
								|--------------------------------------------------
								*/}
								<Pressable className="h-[38px] bg-white flex-row gap-2 justify-center items-center rounded-full w-[96px] right-0">
						...
						*/}
						<View className="p-5">
							<View className="h-[42px] opacity-35 pointer-events-none mb-5 bg-[#1018280D] justify-between rounded-[24px] flex-row items-center px-5">
								<TextInput
									className="text-sm"
									value={searchQuery}
									placeholder="Search"
							...
							<View className="gap-4">
								{HELP.map((help) => (
									<Pressable
										...
										className="h-[43px] px-5 w-full justify-between items-center flex-row border border-[#EEEEEE] rounded-2xl"
									>
										<MPText className="text-sm text-[#333333]" weight="medium">
											{help.tag}
										</MPText>
